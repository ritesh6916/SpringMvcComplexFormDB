...
<body>
	<img alt="my image" src="<c:url value="/resources/images/MyPic01.jpg" />">
		...
		<form >
			...
			<div class="form-row">
				<div class="form-group">
					<img alt="Image Uplpad kiye ho ?" src="<c:url value="/resources/images/${image}" />">
				</div>
			</div>
			<div class="form-row">
				<div class="form-group">
					<img alt="fursat me niklo..." src="<c:url value="/resources/images/${resume}" />">
				</div>
			</div>
		</form>
	</div>
